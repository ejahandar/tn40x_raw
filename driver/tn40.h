...
enum PHY_TYPE
{
    ...
    PHY_TYPE_AQ2104,		/* AQ2104 10baseT				*/
    PHY_TYPE_CNT
};
...
enum
{
    OP_INFO,OP_READ_REG,OP_WRITE_REG,OP_MDIO_READ,OP_MDIO_WRITE,op_TRACE_ON,op_TRACE_OFF,op_TRACE_ONCE, op_TRACE_PRINT
};
...
struct bdx_priv
{
    ...
    u32  						isr_mask;
    int  						link_speed; // 0- no link or SPEED_100 SPEED_1000 SPEED_10000 SPEED_5000 SPEDD_2500
    u32  						link_loop_cnt;
...
#define SUPPORTED_2500baseT_Full 2500
#define ADVERTISED_5000baseT_Full 5000
#define ADVERTISED_2500baseT_Full 2500*/
...
// we can't use paged buffers with raw access
